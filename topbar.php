...
if (!$admin_notifications) {
  echo "Lỗi truy vấn thông báo: " . $conn->error;
}
...
if ($unread_result) {
  ...
  // Ghi log lỗi hoặc hiển thị thông báo, tránh crash
  echo "Lỗi truy vấn: " . $conn->error;
  $unread_count = 0; // gán mặc định để không gây lỗi tiếp
}
...
<style>
  ...
  .dropdown-menu.dropdown-menu-right {
    ...
    /* THÊM DÒNG NÀY */
    white-space: normal;
    /* THÊM DÒNG NÀY để xuống dòng nếu dài */
  }
      ...
      <div class="float-right" style="display: flex; align-items: center;">
        <div class="dropdown mr-3">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="notifDropdown" style="width: 320px; max-height: 350px; overflow-y: auto;">
            ...
            <?php if ($admin_notifications && $admin_notifications->num_rows > 0): ?>
